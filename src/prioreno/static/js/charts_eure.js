...
// DPE eure
var ctx_eure_dpe = document.getElementById("eure_dpe_barchart");
var chart_eure_dpe = new Chart(ctx_eure_dpe, {
  type: 'bar',
  data: {
    labels: labels_eure_dpe,
    datasets: [{
...
// GES eure
var ctx_eure_ges = document.getElementById("eure_ges_barchart");
var chart_eure_ges = new Chart(ctx_eure_ges, {
  type: 'bar',
  data: {
    labels: labels_eure_ges,
    datasets: [{
      label: "Nombre de logements",
      backgroundColor: [
...
// PRECA eure
var ctx_eure_preca = document.getElementById("eure_preca_barchart");
var chart_eure_preca = new Chart(ctx_eure_preca, {
  type: 'horizontalBar',
  data: {
    labels: labels_eure_preca,
    datasets: [{
...
// CONFIANCE eure
var ctx_confiance_eure = document.getElementById("eure_confiance_piechart");
var eure_confiance_piechart = new Chart(ctx_confiance_eure, {
  type: 'doughnut',
  data: {
    labels: labels_eure_confiance,
    datasets: [{
      data: values_eure_confiance,
