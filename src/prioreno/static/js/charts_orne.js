...
// DPE orne
var ctx_orne_dpe = document.getElementById("orne_dpe_barchart");
var chart_orne_dpe = new Chart(ctx_orne_dpe, {
  type: 'bar',
  data: {
    labels: labels_orne_dpe,
    datasets: [{
...
// GES orne
var ctx_orne_ges = document.getElementById("orne_ges_barchart");
var chart_orne_ges = new Chart(ctx_orne_ges, {
  type: 'bar',
  data: {
    labels: labels_orne_ges,
    datasets: [{
      label: "Nombre de logements",
      backgroundColor: [
...
// PRECA orne
var ctx_orne_preca = document.getElementById("orne_preca_barchart");
var chart_orne_preca = new Chart(ctx_orne_preca, {
  type: 'horizontalBar',
  data: {
    labels: labels_orne_preca,
    datasets: [{
...
// CONFIANCE orne
var ctx_confiance_orne = document.getElementById("orne_confiance_piechart");
var orne_confiance_piechart = new Chart(ctx_confiance_orne, {
  type: 'doughnut',
  data: {
    labels: labels_orne_confiance,
    datasets: [{
      data: values_orne_confiance,
