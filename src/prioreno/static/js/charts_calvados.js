...
// DPE CALVADOS
var ctx_calvados_dpe = document.getElementById("calvados_dpe_barchart");
var chart_calvados_dpe = new Chart(ctx_calvados_dpe, {
  type: 'bar',
  data: {
    labels: labels_calvados_dpe,
    datasets: [{
...
// GES CALVADOS
var ctx_calvados_ges = document.getElementById("calvados_ges_barchart");
var chart_calvados_ges = new Chart(ctx_calvados_ges, {
  type: 'bar',
  data: {
    labels: labels_calvados_ges,
    datasets: [{
      label: "Nombre de logements",
      backgroundColor: [
...
// PRECA CALVADOS
var ctx_calvados_preca = document.getElementById("calvados_preca_barchart");
var chart_calvados_preca = new Chart(ctx_calvados_preca, {
  type: 'horizontalBar',
  data: {
    labels: labels_calvados_preca,
    datasets: [{
...
// CONFIANCE CALVADOS
var ctx_confiance_calvados = document.getElementById("calvados_confiance_piechart");
var calvados_confiance_piechart = new Chart(ctx_confiance_calvados, {
  type: 'doughnut',
  data: {
    labels: labels_calvados_confiance,
    datasets: [{
      data: values_calvados_confiance,
